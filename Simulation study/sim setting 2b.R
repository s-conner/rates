...
beta2 <- -.3 # log RR of treatment
beta3 <-  -.01 # larger reduction for HIGHER ppFEV1

#samp_sizes <- c(100,200,500,1000)
samp_sizes <- c(100,200)
res <- NULL
...
for(k in samp_sizes){
  ...
  res_k <- data.frame(matrix(NA, nrow=niter, ncol=47))
  ...
  write.csv(res_k, paste0("sim setting 2b nb 2000k 1000boot n", k, ".csv"), row.names=FALSE)
}
